<footer id="footer" style="background-color: black; color: #ffffff; padding: 20px 0; border-top-right-radius: 20px; border-top-left-radius: 20px;">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
            ...
            <div class="col-md-6 text-md-right">
                <p>Email: <a href="mailto:info@fixmystreet.com" style="color: #ffffff; font-size: 14px; ">mathewswilliam97@gmail.com</a></p>
