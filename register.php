       ...
       margin-top: 82px;"  id="register" class="register">
                        <div class="container">
                            <div class="row align-items-center justify-content-center">
                                <div class="col-lg-6">
                                    <form style=" background-color: #802f3b; box-shadow: 0 20px 30px blue; border-radius: 40px;" id="register-form" method="post"><br>
                                    
                                    <h1 style=" border-radius: 20px; background-color:  #802f3b; box-shadow: 0 20px 30px white; color: black;" class="row align-items-center justify-content-center">REGISTRATION-FORM</h1><br><br>
                                        ...
                                        <p style=" color: black;" >Already have an account? <a  class="btn btn-primary" href="login.php">Login now</a></p>
